...
apiClient_t *apiClient_create() {
    ...
    apiClient->basePath = strdup("https://example.com/todo/opthub-api-endpoint");
...
, list_t *apiKeys_ApiKeyAuth
    ...
    apiClient->progress_data = NULL;
    apiClient->response_code = 0;
    if(apiKeys_ApiKeyAuth!= NULL) {
        apiClient->apiKeys_ApiKeyAuth = list_createList();
        listEntry_t *listEntry = NULL;
        list_ForEach(listEntry, apiKeys_ApiKeyAuth) {
            keyValuePair_t *pair = listEntry->data;
            keyValuePair_t *pairDup = keyValuePair_create(strdup(pair->key), strdup(pair->value));
            list_addElement(apiClient->apiKeys_ApiKeyAuth, pairDup);
        }
    }else{
        apiClient->apiKeys_ApiKeyAuth = NULL;
    }
...
void apiClient_free(apiClient_t *apiClient) {
    ...
    apiClient->progress_func = NULL;
    apiClient->progress_data = NULL;
    if(apiClient->apiKeys_ApiKeyAuth) {
        listEntry_t *listEntry = NULL;
